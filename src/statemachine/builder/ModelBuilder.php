 ...
 * 
 * This class is useful if your domain model actually subclasses the StateMachine class or
 * uses object composition to use the statemachines' logic internally.
 * 
 * In that case, you can construct the StateMachine in your models' constructor, including
 * the Context with this class in it and with the domain model itself ($this) as an argument to
 * the builder.
 * 
